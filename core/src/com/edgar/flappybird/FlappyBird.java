...
public class FlappyBird extends ApplicationAdapter {
	...
	private void detectarColisoes(){
		...
		if( colidiuCanoCima || colidiuCanoBaixo || posicaoInicialVerticalPassaro <= 0 || posicaoInicialVerticalPassaro >= alturaDispositivo ){
			if( estadoJogo == 1 ){
				somColisao.play();
				estadoJogo = 2;
			}
	...
	private void desenharTexturas(){
		...
		if( estadoJogo == 2 ){
			...
			textoReiniciar.draw(batch, "Toque para reiniciar!", larguraDispositivo/2 -190, alturaDispositivo/2 - gameOver.getHeight()/2 );
			textoMelhorPontuacao.draw(batch, "Seu record é: "+ pontuacaoMaxima +" pontos", larguraDispositivo/2 -230,alturaDispositivo/2 - gameOver.getHeight());
		}
